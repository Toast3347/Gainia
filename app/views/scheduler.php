        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="/schedule/addSession">
                    ...
                    <div class="mb-3">
                        <label for="addName" class="form-label">Workout</label>
                        <input type="text" class="form-control" id="addName" name="name" required>
                    </div>
                    <div class="mb-3">
                        <label for="addTime" class="form-label">Duration (hours)</label>
                        <input type="number" step="0.1" class="form-control" id="addTime" name="time" required>
                    </div>
